        ...
        <div className="flex flex-col gap-3 md:flex-row md:justify-center">
          <div className="md:hidden relative">
            ...
            <input
              ...
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="block border border-[#c0c0c0] p-2 pl-10 w-full rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>

          <div className="border border-[#c0c0c0] rounded-md p-1">
            <h3 className="mb-1">Filtrar por especialidad:</h3>
          ...
          <div className="border border-[#c0c0c0] rounded-md p-1">
            <h3 className="mb-1">Filtrar por obra social:</h3>
            <div className="grid grid-cols-[auto_auto_auto] gap-1 md:grid-cols-5">
